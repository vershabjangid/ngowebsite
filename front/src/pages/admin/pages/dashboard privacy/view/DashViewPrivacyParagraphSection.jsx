                                            ...
                                            <form onSubmit={formik.handleSubmit}>
                                                <div className='w-[100%] flex justify-between my-[10px]'>
                                                    <div className='w-[100%]'>
                                                        ...
                                                        <input id='privacybannerheading' autoComplete='true' maxLength={100} defaultValue={updatemodaldata.Privacy_Heading} type="text" className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Privacy_Heading', e.target.value)} />
                                                    </div>
                                                ...
                                                <div className='w-[100%] flex justify-between my-[10px]'>
                                                    <div className='w-[100%]'>
                                                        <label className='font-[600]' htmlFor="privacybannerdescription">
                                                            Privacy Paragraph Description
                                                        </label>
                                                        <input id='privacybannerdescription' autoComplete='true' maxLength={300} defaultValue={updatemodaldata.Privacy_Description} type="text" className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Privacy_Description', e.target.value)} />
                                                    </div>
                                                </div>
                                                ...
                                                <div className='w-[100%] flex justify-between my-[10px]'>
                                                    <div className='w-[100%]'>
                                                        ...
                                                        <input id='privacyimage' type="file" className='w-[100%] p-2 border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Privacy_Image', e.target.files[0])} />
                                                    </div>
                                                </div>
