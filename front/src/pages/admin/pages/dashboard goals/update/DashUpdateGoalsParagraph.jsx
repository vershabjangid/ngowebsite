                                ...
                                <form onSubmit={formik.handleSubmit}>
                                    <div className='w-[100%] flex justify-between my-[10px]'>
                                        <div className='w-[48%]'>
                                            ...
                                            <select defaultValue={data.Home_Card_Content_Id} className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Home_Card_Content_Id', e.target.value) && filterheading(e.target.value)} >
                                        ...
                                        <div className='w-[48%]'>
                                            ...
                                            <select defaultValue={data.Home_Card_Content_Heading} className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Home_Card_Content_Heading', e.target.value)} >
                                                <option>Choose Option</option>
                                                {
                                    ...
                                    <div className='w-[100%] flex justify-between my-[10px]'>
                                        <div className='w-[48%]'>
                                            ...
                                            <input type="text" defaultValue={data.Home_Card_Content_Paragraph} className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Home_Card_Content_Paragraph', e.target.value)} />
                                        </div>
                                    </div>
