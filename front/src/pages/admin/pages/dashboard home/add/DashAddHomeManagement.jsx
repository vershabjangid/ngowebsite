                        ...
                        <section className='w-[100%] '>
                            <form onSubmit={formik.handleSubmit}>
                                <div className='w-[100%] flex justify-between my-[10px]'>
                                    <div className='w-[48%]'>
                                        <label className='font-[600]' htmlFor="homemanangementheading">
                                            Home Management Heading
                                        </label>

                                        <input id='homemanangementheading' autoComplete='true' type="text" className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Home_Management_Heading', e.target.value)} />
                                    ...
                                    <div className='w-[48%]'>
                                        <label className='font-[600]' htmlFor="homemanangementdescription">
                                            Home Management Description
                                        </label>

                                        <input id='homemanangementdescription' autoComplete='true' type="text" className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Home_Management_Description', e.target.value)} />
                                        <div className='text-[#ff6780]'>
