                    ...
                    <form onSubmit={formik.handleSubmit}>
                        <div className='w-[100%] flex justify-between my-[10px]'>
                            <div className='w-[48%]'>
                                ...
                                <input type="text" className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Home_Team_Profile_Name', e.target.value)} />
                            ...
                            <div className='w-[48%]'>
                                ...
                                <input type="text" className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Home_Team_Profile_Designation', e.target.value)} />
                                <div className='text-[#ff6780]'>
                        ...
                        <div className='w-[100%] flex justify-between my-[10px]'>
                            <div className='w-[48%]'>
                                ...
                                <input type="text" className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Home_Team_Profile_Description', e.target.value)} />
                                <div className='text-[#ff6780]'>
                            ...
                            <div className='w-[48%]'>
                                ...
                                <input type="file" className='w-[100%] p-2 border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Home_Team_Profile_Picture', e.target.files[0])} />
                                <div className='text-[#ff6780]'>
