...
export function DashAddHomeManagementCard() {
    let formik = useFormik({
        ...
        validationSchema: Yup.object().shape({
            Home_Management_Profile_Name: Yup.string().required("Full name is required"),
            Home_Management_Profile_Designation: Yup.string().required("Designation is required"),
            Home_Management_Profile_Description: Yup.string().required("Description is required"),
            Home_Management_Profile_Picture: Yup.mixed().test('fileFormat',
                'Only png, jpg, jpeg',
    ...
    let insertdata = (value) => {
        try {
            apiurl.post('/admin/add-home-management-card', toFormData(value), {
                headers: {
