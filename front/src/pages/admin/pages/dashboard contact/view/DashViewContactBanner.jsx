                                            ...
                                            <form onSubmit={formik.handleSubmit}>
                                                <div className='w-[100%] flex justify-between my-[10px]'>
                                                    <div className='w-[100%]'>
                                                        ...
                                                        <input id="contactbannerheading" autoComplete='true' maxLength={100} defaultValue={updatemodaldata.Contact_Banner_Heading} type="text" className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Contact_Banner_Heading', e.target.value)} />
                                                    </div>
                                                ...
                                                <div className='w-[100%] flex justify-between my-[10px]'>
                                                    <div className='w-[100%]'>
                                                        <label className='font-[600]' htmlFor="contactbannerdescription">
                                                            Contact Banner Description
                                                        </label>
                                                        <input maxLength={300} id='contactbannerdescription' autoComplete='true' defaultValue={updatemodaldata.Contact_Banner_Description} type="text" className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Contact_Banner_Description', e.target.value)} />
                                                    </div>
                                                </div>

                                                <div className='w-[100%] flex justify-between my-[10px]'>
                                                    <div className='w-[100%]'>
                                                        <label className='font-[600]' htmlFor="contactimage">
                                                            Contact Banner
                                                        </label>

                                                        <input id='contactimage' type="file" className='w-[100%] p-2 border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Contact_Banner_Image', e.target.files[0])} />
                                                    </div>
                                                </div>
