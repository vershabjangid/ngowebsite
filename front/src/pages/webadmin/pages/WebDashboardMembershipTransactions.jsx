...
export function WebDashboardMembershipTransactions() {
                            ...
                            <section className='w-[100%] h-[100%] overflow-y-scroll'>
                                ...
                                <section className='useradmin_content_section w-[100%]  p-5 text-[30px] overflow-y-scroll'>
                                    ...
                                    <section className='mt-[20px]'>
                                        <Link to={"/dash-transactions"} className={status === "Personal" ? 'text-[14px] border-[2px] font-[600] bg-[#1385ff] text-[#ffffff] px-[20px] py-[6px] rounded-[10px] ' : 'text-[14px] border-dashed border-[2px] font-[600] border-[#1385ff] text-[#1385ff] px-[20px] py-1 rounded-[10px] '} >
                                            Donations
                                        </Link>
