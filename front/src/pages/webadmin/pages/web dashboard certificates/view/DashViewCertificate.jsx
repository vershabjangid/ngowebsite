                                        ...
                                        <div>
                                            <form onSubmit={formik.handleSubmit}>
                                                <div className='w-[100%] mt-3'>
                                                    ...
                                                    <input id='certificateheading' autoComplete='true' type="text" defaultValue={updatemodaldata.Certificate_Heading} className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Certificate_Heading', e.target.value)} />
                                                </div>
                                                ...
                                                <div className='w-[100%] mt-3'>
                                                    ...
                                                    <input type="text" id='lineofappreciate' autoComplete='true' defaultValue={updatemodaldata.Certificate_Description} className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Certificate_Description', e.target.value)} />
                                                ...
                                                <div className='w-[100%] mt-3'>
                                                    <label className='font-[600]' htmlFor='certificatecategory'>
                                                        Certificate Category
                                                    </label>

                                                    <select id='certificatecategory' type="text" defaultValue={updatemodaldata.Certificate_Category} className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Certificate_Category', e.target.value)} >
                                                ...
                                                <div className='w-[100%] mt-3'>
                                                    ...
                                                    <input id='dateofissue' type="date" defaultValue={updatemodaldata.Date_Of_Issue} className='w-[100%] p-[10px] border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Date_Of_Issue', e.target.value)} />
                                                ...
                                                <div className='w-[100%] mt-3'>
                                                    <label className='font-[600]' htmlFor="uploadfile">
                                                        Upload File
                                                    </label>

                                                    <input id='uploadfile' type="file" className='w-[100%] p-2 border-[1px] border-[grey] text-[grey] mt-1 rounded-[25px]' onChange={(e) => formik.setFieldValue('Certificate_File', e.target.files[0])} />
                                                            ...
                                                            <section key={index} className='dashboard_notice w-[30%] mt-5'>
                                                                <section className='mt-[10px] border-[1px] border-[#1385ff] bg-[#c4e0ffa3] p-4 rounded-[10px]'>
                                                                    ...
                                                                    <div className='flex items-center justify-between mt-5'>
                                                                        <a href={imgurl + items.Certificate_File} download={"Certificate_File"} className='flex w-[60%] py-2 bg-[skyblue] rounded-[10px] text-white justify-center items-center font-[600]'><FaDownload className='me-2' /> Download</a>
