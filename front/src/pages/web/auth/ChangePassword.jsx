                        ...
                        <section className='login_right w-[50%] h-[100%] bg-white flex justify-center items-center flex-col overflow-y-scroll pb-4'>
                            <div className='w-[90%]'>
                                <div className='w-[100%]'>
                                    ...
                                    <h1 className='text-[30px] font-[700] text-center text-[var(--primary-color--)]'>New Password</h1>
                                    <p className='text-center mb-[20px] font-[500]'>Please enter your new password and </p>
                                ...
                                <form onSubmit={formik.handleSubmit} className=' w-[100%] flex items-center flex-col'>
                                        ...
                                        inputname.map((items, index) => {
                                            return (
                                                <div key={index} className='login_form_section w-[80%] mt-[15px]'>
                                                    <label htmlFor={`changeinput${index}`} className='text-[15px] font-[600] text-[var(--primary-color--)]'>{labelname[index]}</label>
                                                    {
                                                        inputtype[index] === "password" ?
                                                            <section className='relative'>
                                                                <input id={`changeinput${index}`} type={eye ? "text" : inputtype[index]} autoComplete="true" className='w-[100%] border-[1px] mt-1 border-[black] outline-[var(--primary-color--)] p-3 rounded-[10px] text-[14px]' placeholder={placeholder[index]} onChange={(e) => formik.setFieldValue(inputname[index], e.target.value)} />
                                                            ...
                                                            :
                                                            <input id={`changeinput${index}`} type={inputtype[index]} autoComplete="true" className='w-[100%] border-[1px] mt-1 border-[black] outline-[var(--primary-color--)] p-3 rounded-[10px] text-[14px]' placeholder={placeholder[index]} onChange={(e) => formik.setFieldValue(inputname[index], e.target.value)} />
                                                    }
                                                </div>
                                            )
                                        })
                                    ...
                                    <div className='w-[80%] mt-[20px]'>
                                        <button type='submit' className='w-[100%] bg-[var(--primary-color--)] text-[white] text-[18px] font-[500] py-3 rounded-[10px]'>CHANGE PASSWORD</button>
                                    </div>
                                </form>
                            </div>
                        </section>
