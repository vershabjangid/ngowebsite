                        ...
                        <section className='login_right w-[50%] h-[100%] bg-white flex justify-center items-center flex-col overflow-y-scroll pb-4'>
                            <div className='w-[80%]'>
                                <div className='w-[100%]'>
                                    ...
                                    <h1 className='text-[30px] font-[700] text-center text-[var(--primary-color--)]'>Sign Up</h1>
                                    <p className='text-center mb-[40px] font-[500]'>Please enter your details to Sign Up</p>
                                ...
                                <form action="" className='w-[100%]' onSubmit={formik.handleSubmit}>
                                        ...
                                        inputname.map((items, index) => {
                                            return (
                                                <div key={index} className='register_form_section w-[100%] mt-[15px]'>
                                                    <label className='text-[15px] font-[600] text-[var(--primary-color--)]'>{labelname[index]}</label>
                                                    {
                                                        inputtype[index] === "password" ?
                                                            ...
                                                            :
                                                            <input type={inputtype[index]} autoComplete="true" className='w-[100%] border-[1px] mt-1 border-[black] outline-[var(--primary-color--)] p-3 rounded-[10px] text-[14px]' onChange={(e) => formik.setFieldValue(inputname[index], e.target.value)} />
                                                    }
                                    ...
                                    <div className='mt-[15px]'>
                                        <button className='border-[1px] bg-[var(--primary-color--)] w-[100%] p-1 py-2 mt-1 rounded-[10px] text-white bg-[black] font-[600]'>
                                            Sign Up
                                        </button>
                                    </div>
                                </form>
                                <p className='mt-4 text-center font-[500]'>
                                    Already have an account? <Link to={"/sign-in"} className='font-[600] text-[var(--primary-color--)]'>Sign In</Link>
                                </p>
                            </div>
                        </section>
                        <Toaster />
