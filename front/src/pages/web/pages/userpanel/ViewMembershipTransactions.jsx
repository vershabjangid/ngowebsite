                            ...
                            <section className='flex h-[calc(100%-90px)] border-t-[1px]  overflow-y-scroll'>
                                ...
                                <section className='useradmin_content_section w-[100%]  p-5 text-[30px] overflow-y-scroll'>
                                    ...
                                    <section className='mt-[20px]'>
                                        <Link to={"/transactions"} className={status === "Personal" ? 'text-[14px] border-[2px] font-[600] bg-[#1385ff] text-[#ffffff] px-[20px] py-[6px] rounded-[10px] ' : 'text-[14px] border-dashed border-[2px] font-[600] border-[#1385ff] text-[#1385ff] px-[20px] py-1 rounded-[10px] '} >
                                            Donations
                                        </Link>

                                        <button className='text-[14px] border-[2px] font-[600] bg-[#1385ff] text-[#ffffff] px-[20px] py-[6px] rounded-[10px] ms-2'>
                                            Membership
                                        </button>
                                                ...
                                                return (
                                                    <section key={index} className='dashboard_notice w-[100%] mt-5'>
                                                        <section className='mt-[10px] border-[1px] border-[#1385ff] bg-[#c4e0ffa3] p-4 rounded-[10px]'>
                                                            <div className='flex'>
                                                                <FaDollarSign className='text-[25px] text-[#1385ff]' /> <p className='text-[18px] font-[600] ms-1'>Membership of Rs. {items.Amount.toLocaleString()}</p>
                                                            </div>
