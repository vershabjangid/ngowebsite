...
export function IdCard() {
    ...
    useEffect(() => {
        if (seconds <= 0) {
            if (user[0] === null || user[0] === undefined || user[0].Address === undefined) {
            ...
            <section className='w-[100%] h-[100vh] bg-[#f3f1f1]'>
                ...
                <section className='flex h-[calc(100%-93px)] border-t-[1px] mt-2 overflow-y-scroll'>
                    ...
                    <section className='useradmin_content_section w-[100%]  p-5 text-[30px] overflow-y-scroll'>
                        ...
                        {
                            user[0] === null || user[0] === undefined || user[0].Address === undefined ?
                                <section className='text-center text-[18px] mt-5'>
                                    Membership is required {seconds}
                                </section>
                                :
                                <section className='mt-[30px] flex justify-evenly flex-wrap py-2' ref={contentRef}>
                                    <section className='id_card w-[300px] rounded-[10px] bg-[white]  pt-2 mt-[10px] relative'>
                                        <section className='w-[130px] m-auto mt-2 text-center'>
                                            <Logo />
                                        </section>
                                    ...
                                    <section className='id_card w-[300px] rounded-[10px] bg-[white] mt-[10px] relative'>
                                        <section className='w-[100px] m-auto mt-5 mb-[9px]'>
                                            <Logo />
                                        </section>
