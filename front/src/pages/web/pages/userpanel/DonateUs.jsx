                                        ...
                                        <section className='flex justify-center mt-[50px]'>
                                            <section className='border-[1px] border-[black] w-[400px] rounded-[10px] bg-[white] p-2'>
                                                ...
                                                <form onSubmit={formik.handleSubmit}>
                                                    <div>
                                                        <label htmlFor='name' className='text-[16px] font-[500]'>Name</label>
                                                        <input id='name' autoCorrect='true' type={"text"} defaultValue={user[0] === undefined || user[0] === undefined ? "No Data Found" : user[0].Full_Name} disabled autoComplete="true" className='w-[100%] border-[1px] border-[black] p-3 rounded-[10px] text-[14px]' onChange={(e) => formik.setFieldValue('User_Name', e.target.value)} />
                                                    </div>

                                                    <div>
                                                        <label htmlFor='phone' className='text-[16px] font-[500]'>Phone</label>
                                                        <input id='phone' autoCorrect='true' type={"number"} defaultValue={user[0] === undefined ? "No Data Found" : user[1].Phone} disabled autoComplete="true" className='w-[100%] border-[1px] border-[black] p-3 rounded-[10px] text-[14px]' onChange={(e) => formik.setFieldValue('Phone', e.target.value)} />
                                                    </div>


                                                    <div>
                                                        <label htmlFor='amount' className='text-[16px] font-[500]'>Enter Amount</label>
                                                        <input id='amount' type={"number"} autoComplete="true" className='w-[100%] border-[1px] border-[black] p-3 rounded-[10px] text-[14px]' onChange={(e) => formik.setFieldValue('Amount', e.target.value) || setamount(e.target.value)} />
                                                    ...
                                                    <div>
                                                        <label htmlFor='bankname' className='text-[16px] font-[500]'>Bank Name</label>
                                                        <input id='bankname' type={"text"} autoComplete="true" className='w-[100%] border-[1px] border-[black] p-3 rounded-[10px] text-[14px]' onChange={(e) => formik.setFieldValue('Bank_Name', e.target.value)} />
                                                        <div className='text-[15px] text-[red] mt-1'>
                                                    ...
                                                    <div>
                                                        <label htmlFor='bankbranch' className='text-[16px] font-[500]'>Bank Branch</label>
                                                        <input id='bankbranch' type={"text"} autoComplete="true" className='w-[100%] border-[1px] border-[black] p-3 rounded-[10px] text-[14px]' onChange={(e) => formik.setFieldValue('Branch_Name', e.target.value)} />
                                                        <div className='text-[15px] text-[red] mt-1'>
