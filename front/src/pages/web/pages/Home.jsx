                                                    ...
                                                    <section className='home_goals_options w-[100%] overflow-x-scroll grid grid-flow-col'>
                                                        {
                                                            homegoalscarddata.map((items, index) => {
                                                                return (
                                                                    <section key={index} className={status === index ? 'border-b-[2px] border-[#1385ff] text-[#1385ff] font-[600] cursor-pointer p-[10px] px-[20px] mb-[20px]  whitespace-nowrap' : ' border-b-[2px] border-[black] p-[10px] px-[20px] mb-[20px] cursor-pointer  whitespace-nowrap font-[600]'} onClick={() => setstatus(index)}>
                                                        ...
                                                        homegoalscarddata.map((items, index) => {
                                                            return (
                                                                <section key={index}>
                                                                    {
                                                                        status === index ?
                                                                            <section className='home_our_goals_section w-[100%] flex justify-between p-[10px] rounded-[20px] mb-[20px]'>
