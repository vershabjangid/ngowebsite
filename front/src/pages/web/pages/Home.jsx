                            ...
                            aboutdata === null ?
                                ...
                                <section className='home_about_us w-[100%] py-[20px] px-[10px] flex justify-evenly items-center mt-8'>
                                    ...
                                    <section className='w-[45%] flex flex-col items-start'>
                                        ...
                                        <p className='Home_Page_Heading my-[15px] mb-[20px] leading-[25px] text-[16px]'>
                            ...
                            goalsdata === null || homegoalscarddata.length === 0 ?
                                ...
                                <section className='about_us_section w-[100%] py-[20px] px-[10px] flex mt-8'>
                                    <section className='w-[100%] capitalize text-center'>
                                        ...
                                        <p className='Home_Page_Heading my-[20px] mb-[20px] leading-[25px] text-[16px]'>
                            ...
                            homemanagement === null || homemanagementprofiles.length === 0 ?
                                ...
                                <section className='home_management_profile_section w-[100%] py-[20px] px-[10px] mt-8'>
                                    <section className='w-[100%] text-center'>
                                        ...
                                        <p className='Home_Page_Heading capitalize  my-[20px] mb-[20px] leading-[25px] text-[16px]'>
