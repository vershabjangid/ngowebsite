...
app.use(cors({
  origin: ["https://balkrishnam.org", "https://www.balkrishnam.org"], 
credentials: true
}));
...
const io = new Server(server, {
    cors: {
     origin: ["https://www.balkrishnam.org","https://balkrishnam.org"],
        methods: ["GET", "POST"],
    }
})
...
mongoose.connect('mongodb://localhost:27017/balkrishnam')
    .then(() => {
        server.listen('5500', () => {
